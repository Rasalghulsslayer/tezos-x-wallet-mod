...
The Home screen shows your XTZ and USDC balances on the Tezos X testnet and provides quick access to Send and the faucet.
...
The wallet links to an external **USDC faucet** for the Tezos X testnet. Click the **Faucet** button on the Home screen to open it in a new tab.
