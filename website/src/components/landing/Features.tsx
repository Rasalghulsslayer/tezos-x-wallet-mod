...
const PRODUCTS = [
  {
    ...
    desc: 'An injectable EIP-1193 provider that lets EVM dApps run unmodified on Tezos X. Delegates signing to Temple Wallet via the Beacon protocol.',
    bullets: [
  ...
  },
  {
    ...
    badge: 'Wallet',
    title: 'TezosX Wallet',
    desc: 'A self-custodied wallet — Chrome extension and mobile app. Holds your keys locally and signs transactions itself — no Temple required.',
    bullets: [
...
const FEATURES = [
  ...
  { Icon: KeyRound,title: 'Local Signing',        desc: 'The wallet signs Michelson-runtime operations locally via Taquito InMemorySigner — zero Temple dependency.', accent: '#a855f7' },
