...
**File**: [`packages/wallet/src/injected/provider.ts`](../../packages/wallet/src/injected/provider.ts)
...
**File**: [`packages/wallet/src/content/bridge.ts`](../../packages/wallet/src/content/bridge.ts)
...
**File**: [`packages/wallet/src/background/service-worker.ts`](../../packages/wallet/src/background/service-worker.ts)
...
**File**: [`packages/wallet/src/ui/`](../../packages/wallet/src/ui/)
